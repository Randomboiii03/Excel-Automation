...
def merge():
    try:
        ...
        output_file_path = os.path.join(app.config['UPLOADED_FILES_DEST'], output_file_name)
    ...
    data_to_return = {'message': message, 'download_path': output_file_path, 'file_path': folder_path, 'status': status}
