...
def clean_province(province):
    ...
    province_parts = province.replace('**', '').split()
...
def highlight_n_check_prediction(excel_file_path):    
    ...
    df["PERCENTAGE"] = df["FINAL AREA"] = df["AUTOFIELD DATE"] = ''
    ...
    #         if '**' in area:
    #             cell1.fill = cell2.fill = PatternFill(start_color="ffa200", end_color="ffa200", fill_type="solid") #orange
    #             cell1.font = cell2.font = Font(bold=True)

    #         if not address or len(address) <= 25:
    #             cell1.value = cell2.value = ''
    #             cell1.fill = cell2.fill = PatternFill(start_color="ff4400", end_color="ff4400", fill_type="solid") #red
    #             continue
